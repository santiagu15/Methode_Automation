...
public class MainPage {
	...
	public static String PAGE_EXPANDER = "[ID:200]";
	public static int PAGE_EXPANDER_X = 9;
	public static int PAGE_EXPANDER_Y = 24;
	
	public static String Clicking_MP = "[CLASS:AfxWnd100u; INSTANCE:1]";
	public static int Clicking_MP_X = 134;
	public static int CLICKING_MP_Y = 36;
	
	public static String Bus_Section = "[ID:59648]";
	...
	public static String WORKFLOW_DONE = "[ID:46130]";
	public static int WORKFLOW_DONE_X = 29;
	public static int WORKFLOW_DONE_Y = 53;
	
	public static String WORKFLOW_DONE_OK = "[ID:1]";
	public static int WORKFLOW_DONE_OK_X = 33;
	public static int WORKFLOW_DONE_OK_Y = 12;
	
	public static String EDITION_PREVIEW = "[ID:59392]";
	public static int EDITION_PREVIEW_X = 481;
	public static int EDITION_PREVIEW_Y = 12;
	
	public static String EDITION_PUBLISH = "[ID:59392]";
	public static int EDITION_PUBLISH_X = 532;
	public static int EDITION_PUBLISH_Y = 12;
	
	public static String EDITION_METADATA = "[ID:59392]";
	...
	public static int UPDATETEXT_EDITION_METADATA_X = 93;
	public static int UPDATETEXT_EDITION_METADATA_Y = 77;
	public static String UPDATETEXT_EDITION_METADATA = "9AM UPDATE";
	
	public static int SET_EDITION_TIME_X = 185;
	public static int SET_EDITION_TIME_Y = 409;
